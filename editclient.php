...
<div class="col-md-12">
	...
	<div class="box box-primary">
		...
		if (isset($_GET['id'])) {
		 ...
		 ?>
		<form role="form" action="updateclient.php<?php echo "?id=$id"; ?>" method="post" >
			<div class="box-body">
				<div class="form-group">
					<label for="exampleInputEmail1">ادخل اسم العميل</label>
					<input type="text" name="name" value="<?php echo "$client_name"; ?>" class="form-control" id="exampleInputEmail1" placeholder="اسم العميل">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="text" name="deserved" value="<?php echo "$deserved"; ?>" class="form-control" id="exampleInputPassword1" placeholder="ادخل مستحقات هذا العميل">
				</div>
