						...
						<table  class="table table-bordered table-striped dataTable" aria-describedby="example1_info">
							...
							<tbody role="alert" aria-live="polite" aria-relevant="all"><tr class="odd">
								...
								while ($result=$query->fetch(PDO::FETCH_ASSOC)) {
									...
									echo "<tr class='even'>
									<td>$i</td>
									<td class=''><a href='client_pay.php?id=$client_id'>$client_name</a></td>
									<td class=''>$money</td>
									<td class=''>$dev</td>
									<td class=''>$elbaky</td>
									<td class=''>$date</td>
									<td class=''><a href='deletepayclient.php?id=$id'><button class='btn btn-danger btn-sm'>حذف</button></a>
									</td>
									</tr>";
									$i++;
								}
