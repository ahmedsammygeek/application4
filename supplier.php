		...
		<div class="col-md-12">
			...
			<div class="box box-primary">
				<div class="box-header">
					<h3 class="box-title">اضف مورد جديد</h3>
				</div><!-- /.box-header -->
				<?php 
				if (isset($_GET['msg'])) {
					switch ($_GET['msg']) {
				...
				?>
				<!-- form start -->
				<form role="form" action="addsupplier.php" method="post" >
					<div class="box-body">
						...
						<div class="form-group">
							...
							<input type="text" name="debts" class="form-control" id="exampleInputPassword1" placeholder="ادخل مستحقات هذا المورد">
						</div>

					</div><!-- /.box-body -->

					<div class="box-footer">
						<button type="submit" name="submit" class="btn btn-primary">اضف المورد</button>
					</div>
				</form>
			</div><!-- /.box -->
